...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        <li>
            <!-- to get online users count using php -->
            <!-- have to refresh the page with php -->
            <!-- <a href="">Users online: <?php // echo usersOnline(); ?></a> -->

            <!-- to get online users count using javascript AJAX call -->
            <!-- don't have to refresh the page with javascript -->
            <a href="">Users online: <span class="usersonline"></a>
        </li>
        <li>
            <a href="../">HOME SITE</a>
        </li>
