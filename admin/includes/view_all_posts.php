    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php
                ...
                $send_comment_qeury = mysqli_query($connection, $query);
                $count_comments = mysqli_num_rows($send_comment_qeury);
            ...
            <!-- sending delete using POST instead of GET  -->
            <form method="post">
...
<!-- javascript inside of php for modal POP-UP deletion -->
<script>
// cathing delete button
