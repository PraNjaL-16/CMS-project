...
<?php 
    if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['register'])) {
        ...
        if(username_exists($username)) {
            $error['username'] = 'Username alredy exits, pick another';
        }
        ...
        if(email_exists($email)) {
            $error['email'] = "email alredy exits, <a href='index.php'>Please login</a>";
        }
...
<div class="container">
    ...
    <!-- can submit a form using GET method -->
        ...
        <div class="form-group">
            <select name="lang" class="form-control" onchange="changeLanguage()">
                <Option value="en" <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') echo 'selected' ?>>
                    English</Option>
                <Option value="es" <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'es') echo 'selected' ?>>
                    Spanish</Option>
            </select>
        </div>
    </form>
